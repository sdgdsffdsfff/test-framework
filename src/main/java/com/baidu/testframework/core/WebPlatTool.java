...
import com.baidu.testframework.tools.HttpUtil;
import com.baidu.testframework.tools.Page;
import com.baidu.testframework.tools.ServiceDefine;
...
public class WebPlatTool {
    ...
    public static void download(String webToolAddrs,String serviceId,String path) throws Exception {
        //查找本地cache
        File file = new File(path + File.separator +path + File.separator + serviceId + ".jar");
